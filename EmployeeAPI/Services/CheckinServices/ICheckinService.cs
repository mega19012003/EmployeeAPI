...
namespace EmployeeAPI.Services.CheckinServices
{
    public interface ICheckinService
    {
        ...
        Task<ResponseModel.CheckinResultDto> CheckinAsync(Guid? userId, string DeviceInfo, string ip, string note, Guid currentUserId, IList<string> roles);
        Task<ResponseModel.CheckinResultDto> CheckoutAsync(Guid? userId, string DeviceInfo, string ip, string note, Guid currentUserId, IList<string> roles);
