...
namespace EmployeeAPI.Services.DepartmentServices
{
    public interface IDepartmentService
    {
        ...
        public Task<ResponseModel.CreateDepartment> AddAsync(string Name, ClaimsPrincipal claim);
        public Task<ResponseModel.UpdateDepartment> UpdateAsync(Guid id, string Name, ClaimsPrincipal claim);
        public Task<string> SoftDeleteAsync(Guid id, ClaimsPrincipal claim);
