...
namespace EmployeeAPI.Services.UserService
{
    public interface IUserService
    {
        ...
        Task<PagedResult<ResponseModel.UserResultDto>> GetAllAsync(string? SearchTerm, bool? IsActive, Guid? positionId, Guid? departmentId, Guid? companyId, Guid currentUserId, IList<string> currentUserRoles, int? pageIndex, int? pageSize, int? Month);
