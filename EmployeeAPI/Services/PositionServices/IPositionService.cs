...
namespace EmployeeAPI.Services.PositionServices
{
     public interface IPositionService
     {
        ...
        Task<PagedResult<ResponseModel.PositionDTO>> GetAllAsync(string? name, Guid? companyId, Guid? departmentId, int? pageIndex, int? pageSize, Guid currentUserId, IList<string> currentUserRole);
