...
namespace EmployeeAPI.Controllers
{
    ...
    public class DutyController : ControllerBase
    {
        ...
        [Authorize]
        [HttpGet]
        public async Task<IActionResult> GetAll(string? Search, Guid? companyId, int? day, int? month, int? year, string? status, int? pageSize, int? pageIndex)
        {
            ...
            var pagedResult = await _dutyService.GetAllAsync(currentUserId, currentUserRoles, Search, companyId, day, month, year, status, pageIndex, pageSize);
